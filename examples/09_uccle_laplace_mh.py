"""Fit Uccle monthly extremes with exact Laplace-MH state updates.
...
The calibrated values come from the same ``config/uccle.json`` as examples 05
and 06; the model, exact fit, result tables, and figures stay explicit.
"""
