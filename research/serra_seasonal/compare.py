...
from research.serra.report import new_run,scientific_targets,convergence_parameters
...
def main():
    ...
    parser.add_argument('--config',default='research/serra_seasonal/config/compare.json')
