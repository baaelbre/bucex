#!/usr/bin/env python3
"""Fixed-seed numerical release validation for bucex 1.0.0."""
...
def run() -> dict[str, object]:
    ...
    if bx.__version__ != "1.0.0":
        raise RuntimeError(f"Expected bucex 1.0.0, found {bx.__version__}.")
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("validation/release_validation_1.0.0.json"),
    )
