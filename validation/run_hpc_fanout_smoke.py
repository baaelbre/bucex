#!/usr/bin/env python3
"""Real two-task/one-finalizer smoke test for the 1.2.1 PBS workflow."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--work-dir",
        type=Path,
        default=Path("validation/hpc_fanout_smoke_artifacts_1.2.1"),
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("validation/hpc_fanout_smoke_1.2.1.json"),
    )
