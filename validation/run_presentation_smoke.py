#!/usr/bin/env python3
"""Direct-API smoke validation for the ten bucex 1.2.0 examples."""
...
def main() -> None:
    ...
    parser.add_argument("--work-dir", type=Path, default=Path("validation/smoke_artifacts_1.2.0"))
    parser.add_argument("--output", type=Path, default=Path("validation/presentation_smoke_1.2.0.json"))
