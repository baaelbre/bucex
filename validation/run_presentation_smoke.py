#!/usr/bin/env python3
"""Direct-API smoke validation for the bucex 1.4.1 examples."""
...
def main() -> None:
    ...
    parser.add_argument("--work-dir", type=Path, default=Path("validation/smoke_artifacts_1.4.1"))
    parser.add_argument("--output", type=Path, default=Path("validation/presentation_smoke_1.4.1.json"))
