#!/usr/bin/env python3
"""Direct-API smoke validation for the ten bucex 1.3.1 examples."""
...
def main() -> None:
    ...
    parser.add_argument("--work-dir", type=Path, default=Path("validation/smoke_artifacts_1.3.1"))
    parser.add_argument("--output", type=Path, default=Path("validation/presentation_smoke_1.3.1.json"))
